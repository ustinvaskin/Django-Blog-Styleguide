...
SECRET_KEY = '@gwo)vl_&)j&(f0h92)@nye-bfqkqbb7x(&ywuap+u6#jon!p$'
...
INSTALLED_APPS = [
    ...
    'rest_framework', # Registering the rest framework in the installed apps
    'jwt_auth', # registering our jwt_auth app
    'posts' # registering our posts app
]
